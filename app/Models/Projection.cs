...
{
    [JsonPropertyName("par_rates")] public List<double> ParRates { get; set; }

    [JsonPropertyName("par_maturities")] public List<int> ParMaturities { get; set; }

    [JsonPropertyName("projection")] public List<int> Projection { get; set; }

    [JsonPropertyName("ufr")] public double Ufr { get; set; }

    [JsonPropertyName("convergence_maturity")]
    public int ConvergenceMaturity { get; set; }

    [JsonPropertyName("tol")] public double Tol { get; set; }
    [JsonPropertyName("blaha")] public int Blaha { get; set; }
}
